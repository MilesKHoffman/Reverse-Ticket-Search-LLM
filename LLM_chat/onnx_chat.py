...
def main(args):
    ...
    search_options = {name: getattr(args, name) for name in
...
if __name__ == "__main__":
    ...
    parser.add_argument('-ds', '--do_sample', action='store_true', default=False,
    ...
    parser.add_argument('-g', '--timings', action='store_true', default=False,
                        help='Print timing information for ea=ch generation step. Defaults to false')
    args = parser.parse_args()


    args.model = r"C:\Users\Miles\LLMs\Models\huggingface\Phi-3-mini-4k-instruct-onnx\cuda\cuda-int4-rtn-block-32"
    args.verbose = True
    args.timings = True
